    ...
    fun from(client: ClientModel, userDetails: UserDetailsModel): PersonalDataViewState {
        ...
        return PersonalDataViewState(
            ...
            gender = if (client.gender != null) {
                if (client.gender == Gender.MALE) TranslationInteractor.getTranslation("app.profile.client.sex_male") else TranslationInteractor.getTranslation("app.profile.client.sex_female")
            } else "",
