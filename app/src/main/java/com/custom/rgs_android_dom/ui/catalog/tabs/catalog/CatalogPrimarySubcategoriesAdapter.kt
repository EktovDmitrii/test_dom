...
import com.custom.rgs_android_dom.databinding.ItemCatalogPrimarySmallSubcategoryBinding
...
class CatalogPrimarySubcategoriesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CatalogPrimarySubcategoryViewHolder {
        val binding = ItemCatalogPrimarySmallSubcategoryBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CatalogPrimarySubcategoryViewHolder(
        private val binding: ItemCatalogPrimarySmallSubcategoryBinding,
