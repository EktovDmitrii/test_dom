...
data class OrderResponse (
    ...
    @SerializedName("address") val address: OrderAddressResponse? = null,
    @SerializedName("client") val client: OrderClientResponse? = null,
    ...
    @SerializedName("deliveryTime") val deliveryTime: DeliveryTimeResponse? = null,
    @SerializedName("provider") val provider: ProviderResponse? = null,
    @SerializedName("refId") val refId: String? = null,
    @SerializedName("services") val services: List<ServicesResponse>? = null,
    @SerializedName("status") val status: String? = null
)

data class ServicesResponse (
    @SerializedName("clientProductId") val clientProductId: String? = null,
    @SerializedName("clientServiceId") val clientServiceId: String? = null,
    @SerializedName("defaultProduct") val defaultProduct: Boolean? = null,
    @SerializedName("productIcon") val productIcon: String? = null,
    ...
    @SerializedName("serviceDeliveryType") val serviceDeliveryType: String? = null,
    @SerializedName("serviceFixPrice") val serviceFixPrice: Boolean? = null,
    @SerializedName("serviceIdInGroup") val serviceIdInGroup: String? = null,
    @SerializedName("serviceLogoMiddle") val serviceLogoMiddle: String? = null,
    @SerializedName("serviceName") val serviceName: String? = null,
    @SerializedName("serviceType") val serviceType: String? = null,
    @SerializedName("serviceVersionId") val serviceVersionId: String? = null
)
...
data class OrderAddressResponse (
    ...
    @SerializedName("cityFiasId") val cityFiasId: String? = null,
    @SerializedName("cityName") val cityName: String? = null,
    @SerializedName("fiasId") val fiasId: String? = null,
    @SerializedName("regionFiasId") val regionFiasId: String? = null,
